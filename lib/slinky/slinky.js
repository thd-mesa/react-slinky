...
var _slinkySections = require('./components/slinkySections');

var _slinkySections2 = _interopRequireDefault(_slinkySections);
...
var Slinky = function (_React$Component) {
    ...
    _createClass(Slinky, [{
        ...
        value: function render() {
            ...
            var slinkyContainerClassName = 'slinky-container';
            if (className) {
                slinkyContainerClassName += ' ' + className;
            }

            var slinkySections = (0, _slinkySections2.default)({
                sections: sections,
